...
export default function BTeamCards() {
  return (
   <div className='container d-flex justify-content-evenly align-items-center row row-cols-1 row-cols-md-3 g-3 align-self-center mt-3' style={{margin: "auto"}}>
    

        <div className="card mb-3 p-3 m-5 col shadow bg-body rounded profile-card-3" style={{maxWidth: "18rem", minWidth: "30rem", height: "350px" }}>
        ...
        <div className="card text-black mb-3 p-3 m-5 col shadow bg-body rounded profile-card-1" style={{maxWidth: "18rem", minWidth: "30rem", height: "350px" }}>
